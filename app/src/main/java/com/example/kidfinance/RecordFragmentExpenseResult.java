...
public class RecordFragmentExpenseResult extends Fragment {

    public RecordFragmentExpenseResult() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        for (int i = 0; i < jsonArray.size(); ++i) {
            ...
            float Amount = rec.get("amount").getAsFloat() * -1;

            System.out.println("FloatAmount: " + Amount);
            String ExpenseType = rec.get("expenseType").getAsString();

            if (ExpenseType.equals("Living")) {
                Amounts[0] += Amount;
            } else if (ExpenseType.equals("Transport")) {
                Amounts[1] += Amount;
            } else if (ExpenseType.equals("Study")) {
                Amounts[2] += Amount;
            } else if (ExpenseType.equals("Entertainment")) {
                Amounts[3] += Amount;
        ...
        value.add(new PieEntry(Amounts[0], "Living"));
        value.add(new PieEntry(Amounts[1], "Transport"));
        value.add(new PieEntry(Amounts[2], "Study"));
        value.add(new PieEntry(Amounts[3], "Entertainment"));
